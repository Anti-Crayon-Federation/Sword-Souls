...
public class Door : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _doorOpenedPos = new Vector3(transform.position.x, transform.position.y + 3.5f, transform.position.z);
    }
    ...
    void OpenDoor()
    {
        ...
        {
            transform.position = Vector3.MoveTowards(transform.position, _doorOpenedPos, _doorSpeed * Time.deltaTime);
        }
    }
